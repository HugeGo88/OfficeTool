...
public sealed partial class ShellPage : Page
{
    ...
    public ShellPage(ShellViewModel viewModel)
    {
        ...
        // Populate navigation menu items dynamically
        BuildNavigationMenu();
    ...
    private void BuildNavigationMenu()
    {
        ...
        foreach (var menuItem in ViewModel.NavigationMenuItems)
        {
            ...
            navItem.SetValue(NavigationHelper.NavigateToProperty, menuItem.PageKey);
            NavigationViewControl.MenuItems.Add(navItem);
        }

        NavigationViewControl.FooterMenuItems.Clear();

        foreach (var menuItem in ViewModel.NavigationFooterMenuItems)
        {
            var navItem = new NavigationViewItem
            {
                Content = menuItem.Label,
