...
using OfficeTool.Notifications;
using OfficeTool.Services;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<StartDetailViewModel>();
            services.AddTransient<StartDetailPage>();
